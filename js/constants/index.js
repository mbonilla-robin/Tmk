...
const ESTADOS_MAPA = [
  ...
  { id: "Seguimiento", dot: "bg-sky-500", bg: "bg-sky-50 text-sky-700 border-sky-150" },
  { id: "Espera de comentarios", dot: "bg-amber-500", bg: "bg-amber-50 text-amber-700 border-amber-150" },
